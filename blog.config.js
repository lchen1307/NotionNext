...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    // '2c79d11fc50f815a89d3e7266a1c3d97,en:3019d11fc50f80a79f8add78da24ee84',
    '2c79d11fc50f815a89d3e7266a1c3d97',
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 160, // 更新缓存间隔 单位(秒)；即每个页面有60秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'light', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 6], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式


  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '一只芝士鱼', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'MSc. Student in IEOR @USTC', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lchen1307.github.io', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/lchen1307/lchen1307.github.io/refs/heads/master/images/fish-.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GREETING_WORDS:
    ...
    'Hi，我是 INFJ and 双鱼座 ♓️, Hi，我是一个研究牲, Hi，我是一个干饭人, 欢迎来到我的博客 🎉, 宇宙校准潮汐，银河计算永恒 🌊',
